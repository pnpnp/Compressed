<%@page import="com.lti.model.Customer"%>
    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="customerprofile">Profile</a></li>
    ...
    <!-- <button type="button" class="btn btn-success">User Details</button> &nbsp; &nbsp;
        <button type="button" class="btn btn-warning">View Documents</button> &nbsp; &nbsp;
            <button type="button" class="btn btn-danger">Loan Tracker</button>> &nbsp; &nbsp;
                ...
                Middle Name: <%=session.getAttribute("middleName")%>  <br>
                Last Name: <%=session.getAttribute("lastName")%>  <br>
                Gender: <%=session.getAttribute("gender")%>  <br>
<%--                 DOB<br> <%=session.getAttribute("country")%>  <br>
 --%>           Email ID: <%=session.getAttribute("emailId")%>  <br>
                Mobile Number: <%=session.getAttribute("mobile")%>  <br>
<%--                 Address<br> <%=session.getAttribute("country")%>  <br>
 --%>                Country:  <%=session.getAttribute("country")%>  <br>
                PAN:  <%=session.getAttribute("pan")%>  <br>
                Aadhar: <%=session.getAttribute("aadhar")%>  <br> <br>
                
                
                <h2> Employment Details </h2>
                Type of Employment : <%=session.getAttribute("typeOfEmp")%><br>
                Monthly Salary : <%=session.getAttribute("salary")%><br>
                Retirement Age : <%=session.getAttribute("retirementAge")%><br>
                Organization Type: <%=session.getAttribute("organizationType")%> <br>
                Employer Name : <%=session.getAttribute("empName")%> <br>
