...
function CalculateEligibility()
{
  ...
  document.getElementById("demo").innerHTML = 'You are eligible for a maximum loan amount of ' +maxAmount;
    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="calculators2">Calculator</a></li>
    ...
    <br> <br>
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h2  class="text-center">Eligibility Calculator</h2>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3">
                        <div class="input-group">
                            ...
                            <input class="form-control" id="monthlyIncome" name="monthlyIncome" value="" placeholder="Enter your monthly income" type="number" oninput="validity.valid||(value='');" required>
                        </div>
                    </div>
                    <!-- /.input group -->
                </div>
                ...
                <div class="reset">
                    <button type="button" class="btn btn-success" onclick='CalculateEligibility();'>Calculate Eligibility</button>
                    </div>
