...
<body>
  ...
  ============================-->
	<section id="intro2">
		<br> <br> <br> <br> <br>
		<h2 class="text-center">Approved Details</h2>
		...
		<b>Personal Details</b><br> First Name <br> Middle Name <br>
		Last Name <br> Gender<br> DOB<br> Email ID<br>
		Mobile Number<br> Address<br> Country<br> PAN <br>
		Aadhar<br>
		<br> <b>Employment Details</b><br> Type of Employment<br>
		Monthly Salary<br> Retirement Age<br> Organization Type <br>
		Employer Name <br>
		<br> <b>Documents</b><br> Aadhar Card <br> PAN Card <br>
		Voter ID <br> Salary Slip<br> Letter Of Agreement <br>
		No Objection Certificate<br> Agreement To Sale<br>
