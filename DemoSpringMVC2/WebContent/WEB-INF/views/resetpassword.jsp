    ...
    <form role="form" method="post">
        <div class="box box-primary">
            <div class="box-header">
                <h2 class="text-center"><i class="fa fa-lock"></i> Reset Password</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3">
                        <div class="input-group">
                            ...
                            <input class="form-control" id="oldPassword" name="oldPassword" value="" placeholder="Enter the Old Password" type="password" required>
                        </div>
                    </div>
                    <!-- /.input group -->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3">
                        <div class="input-group">
                            ...
                            <input class="form-control" id="newPassword" name="newPassword" value="" placeholder="Enter the New Password" type="password" required>
                        </div>
                    </div>
                    <!-- /.input group -->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3">
                        <div class="input-group">
                            ...
                            <input class="form-control" id="confirmPassword" name="confirmPassword" value="" placeholder="Re-enter the New Password" type="password" required>
                        </div>
                    </div>
                    <!-- /.input group -->
                </div>
                <div class="reset">
                    <button type="button" class="btn btn-danger">Reset</div>
