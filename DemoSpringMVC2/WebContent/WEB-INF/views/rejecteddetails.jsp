...
<body>
        ...
        <div class="container-fluid">
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    ...
                    <li class="menu-active"><a href="profile">Profile</a></li>
  ...
  ============================-->
    <section id="intro2">
        ...
        <br> <br>
        <br> <br>
        <h2 class="text-center"> Rejected Details</h2>
        ...
        <footer id="footer">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 footer-info">
                            ...
                            <p>We are here to guide you on <br>everything you need to know <br>about availing a home
                                loan.</p>
            ...
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    Disclaimer - "As regards deposit taking activity of the company, the viewers may refer to the
                    advertisement in the newspaper / information furnished in the application form for soliciting
                    public deposits; published on June 28, 2018 in the Free Press Journal and in Navshakti, Mumbai,
                    respectively. The Company is having a valid Certificate of Registration dated 31/07/2001 issued by
                    the National Housing Bank under Section 29A of the National Housing Bank Act, 1987. However, the
                    National Housing Bank does not accept any responsibility or guarantee about the present position as
                    ...
                    *The information mentioned herein is subject to change without prior notice. <br> Please visit your
                    nearest United branch for detailed information on our various products and changes, if any. Terms
