    ...
    <form role="form" method="post">
        <div class="box box-primary">
            <div class="box-header">
                ...
                <h2  class="text-center">Enter Income Details</h2>
                
            </div>
            <!-- /.box-header -->
            <label>Type of Employment</label> &nbsp; &nbsp;
                <input type="radio" name="empType" value="salaried" checked> Salaried  &nbsp;
                <input type="radio" name="empType" value="selfEmployed"> Self Employed
                  <br> <br>

                  <label>Monthly Salary</label> &nbsp; &nbsp;
            <input type="number" min="0" id="salary" oninput="validity.valid||(value='');">
                <br> <br>

            <label>Retirement Age</label> &nbsp; &nbsp;
            <input type="number" min="0" id="retAge" oninput="validity.valid||(value='');">
                <br> <br>

                <label>Organization Type</label> &nbsp; &nbsp;
                <input type="radio" name="orgType" value="private" checked> Private  &nbsp;
                <input type="radio" name="orgType" value="government"> Government
                <br> <br>

                <label>Employer Name</label> &nbsp; &nbsp;
            <input type="text" placeholder="Enter Employer Name" id="empName">
                <br> <br>

                
                
                <%=session.getAttribute("retirementAge") %>
                
               
            
                <div class="reset">
                    <button type="button" class="btn btn-success">Submit</div>
