    ...
    <form role="form" method="post">
        <div class="box box-primary">
            <div class="box-header">
                ...
                <h2  class="text-center">Upload Loan Documents</h2>
                
            </div>
            <!-- /.box-header -->
            <label>Voter ID</label> &nbsp; &nbsp;
            <input type="file" id="voterId"> <br> <br>

            <label>Salary Slip</label> &nbsp; &nbsp;
            <input type="file" id="salarySlip">
                <br> <br>

                <label>Letter Of Agreement</label> &nbsp; &nbsp;
            <input type="file" id="loa">
                <br> <br>

                <label>No Objection Certificate</label> &nbsp; &nbsp;
            <input type="file" id="noc">
                <br> <br>

                
                <label>Agreement To Sale</label> &nbsp; &nbsp;
            <input type="file" id="ats">
                <br> <br>
            
                <div class="reset">
                    <button type="button" class="btn btn-success">Upload</div>
