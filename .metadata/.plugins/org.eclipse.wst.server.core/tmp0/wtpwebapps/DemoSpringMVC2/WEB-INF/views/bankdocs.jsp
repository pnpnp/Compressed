    ...
    <form role="form" method="post">
        <div class="box box-primary">
            <div class="box-header">
                ...
                <h2  class="text-center">Upload Bank Documents</h2>
                
            </div>
            <!-- /.box-header -->
            <label>Aadhar Card</label> &nbsp; &nbsp;
            <input type="file" id="aadharCard"> <br> <br>
            ...
            <input type="file" id="panCard">
                ...
                <div class="reset">
                    <button type="button" onclick="alert('Sure?')" class="btn btn-success">Upload</div>
