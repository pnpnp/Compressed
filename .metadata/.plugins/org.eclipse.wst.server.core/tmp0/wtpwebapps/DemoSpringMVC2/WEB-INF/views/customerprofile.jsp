...
<!--     <h2 class="text-center"> Welcome User!</h2>
 -->    <h2 class="text-center"> Welcome <%=session.getAttribute("firstName")%>  </h2><br>
...
<div align="center">
                <a href="userdetails" class="btn btn-success" role="button">User Details</a> &nbsp; &nbsp;
                <a href="propertydetails" class="btn btn-warning" role="button">Property Details</a> &nbsp; &nbsp;
                <a href="loantracker" class="btn btn-danger" role="button">Loan Tracker</a> &nbsp; &nbsp;
                <a href="accountdetails" class="btn btn-info" role="button">Account Details</a> &nbsp; &nbsp;
