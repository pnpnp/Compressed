  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li ><a href="">Home</a></li>
          <li class="menu-active"><a href="calculators">Calculators</a></li>
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Calculators</h2>
                <p>Calculate your Eligibility and EMI for Loan below</p>
                <a href="eligibilitycalculator" class="btn-get-started scrollto">Eligibility Calculator</a>

                <a href="emicalculator" class="btn-get-started scrollto">EMI Calculator</a>
