    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
                ...
                <li class="menu-active"><a href="faq">FAQ</a></li>
...
Q: What is a Home Loan? <br>

A: Home loan is a loan disbursed by a bank or financial institution (lender) to an individual specifically for buying a residential property. Here, the lender holds the title of property until the loan is paid back in full along with interest. <br><br>

Q: What is the Eligibility Criteria for a Home Loan?<br>

A: Anyone — whether self employed or salaried individuals/professionals — with a regular source of income can apply for home loans. One must be at least 21 years old when the loan period begins and should not exceed an age of 65 years when the loan ends or at the time of superannuation. <br><br>

Q: What documents do I need to submit with my home loan application?<br>

A: Completed loan application form<br>
Passport size photographs<br>
Identity proof – PAN card, Voters ID, Aadhar Card <br>
Salary Slip<br>
