  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="index.jsp" class="scrollto">United Home Loans</a></h1>
...
<!--         <a href="#intro"><img src="img/logo.png" alt="" title="" /></a>
 -->      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
         <li class="menu-active"><a href="index1">Home</a></li>
            <li><a href="calculators1">Calculators</a></li>
...
<p>  Add wings to your imagination. Get your dream home. </p>
                ...
                <a href="#featured-services" class="btn-get-started scrollto">Apply Now</a>
              </div>
            </div>
          </div>

          <div class="carousel-item">
            <div class="carousel-background"><img src="${pageContext.request.contextPath}/resources/img/intro-carousel/2.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
...
<p> Make your dream home a reality with United Home Loans </p>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="${pageContext.request.contextPath}/resources/img/intro-carousel/3.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>24/7 Customer Support</h2>
<p> Available for you. Always. <br>24 hours a day, 7 days a week, 365 days a year. 
</p>
                <a href="#featured-services" class="btn-get-started scrollto">Apply Now</a>
              </div>
            </div>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="${pageContext.request.contextPath}/resources/img/intro-carousel/4.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Hassle-free Process</h2>
                <p>Getting a home loan from United Home Loans is quick and easy.</p>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="${pageContext.request.contextPath}/resources/img/intro-carousel/5.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>100% Customer Satisfaction</h2>
<p>Going the extra mile for our customers <br> is our commitment.
</p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 box">
            ...
            <h4 class="title"><a href="">Attractive Interest Rates</a></h4>
            <p class="description">1Every day is a journey, and the journey itself is home.</p>
          </div>

          <div class="col-lg-4 box box-bg">
            <i class="ion-ios-stopwatch-outline"></i>
            <h4 class="title"><a href="">Quick Approval</a></h4>
            <p class="description">ex ea commodo consequat tarad limino ata</p>
          </div>
    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3>About Us</h3>
          <p>Transforming dreams to build a nation of proud homeowners. <br> For over three decades, United Home Loans has been providing easy access to <br> affordable Housing Finance to realise home-ownership aspirations of <br> millions of Lower and Middle income families in semi-urban and rural India.</p>
        </header>
        ...
        <div class="row about-cols">
          <div class="col-md-4 wow fadeInUp">
            <div class="about-col">
              <div class="img">
                <img src="${pageContext.request.contextPath}/resources/img/about-mission.jpg" alt="" class="img-fluid">
                <div class="icon"><i class="ion-android-document"></i></div>
              </div>
              <h2 class="title"><a href="#">KYC Documents</a></h2>
              <p>
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
            <div class="about-col">
              <div class="img">
                <img src="${pageContext.request.contextPath}/resources/img/about-plan.jpg" alt="" class="img-fluid">
                <div class="icon"><i class="ion-card"></i></div>
              </div>
              <h2 class="title"><a href="#">Income Documents</a></h2>
              <p>
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              <div class="img">
                <img src="${pageContext.request.contextPath}/resources/img/about-vision.jpg" alt="" class="img-fluid">
                <div class="icon"><i class="ion-home"></i></div>
              </div>
              <h2 class="title"><a href="#">Property Documents</a></h2>
              <p>
                  Documents such as Agreement to Sale, NOC, etc.
              </p>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="owl-carousel testimonials-carousel">
          ...
          <div class="testimonial-item">
            <img src="${pageContext.request.contextPath}/resources/img/testimonial-1.jpg" class="testimonial-img" alt="">
            <h3>Saul Goodman</h3>
            <h4>Ceo &amp; Founder</h4>
            <p>
              <img src="${pageContext.request.contextPath}/resources/img/quote-sign-left.png" class="quote-sign-left" alt="">
              I am really impressed by United's service as they always try and serve you better.
              <img src="${pageContext.request.contextPath}/resources/img/quote-sign-right.png" class="quote-sign-right" alt="">
            </p>
          </div>

          <div class="testimonial-item">
            <img src="${pageContext.request.contextPath}/resources/img/testimonial-2.jpg" class="testimonial-img" alt="">
            <h3>Sara Wilsson</h3>
            <h4>Designer</h4>
            <p>
              <img src="${pageContext.request.contextPath}/resources/img/quote-sign-left.png" class="quote-sign-left" alt="">
              I got a loan in the shortest time period and that too without any difficulty. I take pride in owning a home today. 
              <img src="${pageContext.request.contextPath}/resources/img/quote-sign-right.png" class="quote-sign-right" alt="">
            </p>
          </div>

          <div class="testimonial-item">
            <img src="${pageContext.request.contextPath}/resources/img/testimonial-3.jpg" class="testimonial-img" alt="">
            <h3>Jena Karlis</h3>
            <h4>Store Owner</h4>
            <p>
              <img src="${pageContext.request.contextPath}/resources/img/quote-sign-left.png" class="quote-sign-left" alt="">
              Other banks offer a very high interest rate, while United helped me to buy my dream home by providing me a low interest rate. 
              <img src="${pageContext.request.contextPath}/resources/img/quote-sign-right.png" class="quote-sign-right" alt="">
            </p>
          </div>

          <div class="testimonial-item">
            <img src="${pageContext.request.contextPath}/resources/img/testimonial-4.jpg" class="testimonial-img" alt="">
            <h3>Matt Brandon</h3>
            <h4>Freelancer</h4>
            <p>
              <img src="${pageContext.request.contextPath}/resources/img/quote-sign-left.png" class="quote-sign-left" alt="">
              I was very upset with the tedious processes of other banks for a home loan. United sanctioned my loan without any hassles.
              <img src="${pageContext.request.contextPath}/resources/img/quote-sign-right.png" class="quote-sign-right" alt="">
            </p>
          </div>

          <div class="testimonial-item">
            <img src="${pageContext.request.contextPath}/resources/img/testimonial-5.jpg" class="testimonial-img" alt="">
            <h3>John Larson</h3>
            <h4>Entrepreneur</h4>
            <p>
              <img src="${pageContext.request.contextPath}/resources/img/quote-sign-left.png" class="quote-sign-left" alt="">
              Other banks refused to give me a home loan because I work in an informal sector, United believed in my growth and supported me.
              <img src="${pageContext.request.contextPath}/resources/img/quote-sign-right.png" class="quote-sign-right" alt="">
            </p>
          </div>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Address</h3>
              <address>TTC Electronic Zone, Mahape Road, Navi Mumbai, Maharashtra 400710, India</address>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p><a href="tel:02267954545"> 022 6795 4545</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="mailto:unitedhl@gmail.com">unitedhl@gmail.com</a></p>
            </div>
          </div>
