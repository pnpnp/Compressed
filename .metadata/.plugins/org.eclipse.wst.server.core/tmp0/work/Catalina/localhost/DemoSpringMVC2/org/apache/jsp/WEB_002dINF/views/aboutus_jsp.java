 ...
 * Generated at: 2019-01-20 16:16:36 UTC
...
return;
    ...
    try {
      ...
      out.write("        <!-- <a href=\"#intro\"><img src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      ...
      out.write("            <li class=\"menu-active\"><a href=\"aboutus\">About Us</a></li>\r\n");
      ...
      out.write("                <p>Transforming dreams to build a nation of proud homeowners. For over three decades, United Home Loans has been providing easy access to affordable Housing Finance to realise home-ownership aspirations of millions of Lower and Middle income families in semi-urban and rural India. <br> <br>\r\n");
      out.write("\r\n");
      out.write("                   United Home Loans was established in 1984 with this goal, by a visionary leader Late Shri Rajesh Kumar Wadhawan. He observed that most Indians were unable to buy their dream home and committed himself to transforming the lives of Indian households by enabling access to home ownership through the inception of United Home Loans. <br> <br>\r\n");
      out.write("\r\n");
      out.write("                    Led by Chairman & Managing Director, Mr. Kapil Wadhawan, United Home Loans has strengthened its position as one of Indiaâs leading housing finance companies and has been benchmarked as a model and a pioneer for expanding financial inclusion across India.\r\n");
      out.write("                    <br> <br>\r\n");
      out.write("                    Home ownership is all about âtrustâ. United Home Loans is your âtrusted partnerâ bringing confidence and transparency to every relationship -- helping you make the right decisions and hand holding you through the entire home purchase process. Our purpose-driven team is enthusiastic and committed towards fulfilling your dream. United Home Loans is rated CARE AAA and achieved BWR FAAA from Brickwork Ratings, which indicate the highest degree of safety regarding timely servicing of financial obligations.\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
